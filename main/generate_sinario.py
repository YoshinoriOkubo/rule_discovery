...
freight_outward = Freight(demand.predicted_data,supply.predicted_data,sinario.predicted_data)
freight_outward.generate_sinario(OUTWARD)
freight_return = Freight(demand.predicted_data,supply.predicted_data,sinario.predicted_data)
