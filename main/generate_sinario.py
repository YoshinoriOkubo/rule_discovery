...
freight = Freight(demand.predicted_data,supply.predicted_data)
freight.generate_sinario()
#export_scenario_csv(sinario,freight_outward,freight_return,exchange)
depict_scenario(sinario,freight,freight_return,exchange,demand,supply)
depict_whole_scenario(sinario,freight,exchange,demand,supply)
depict_distribution(sinario,freight,exchange,demand,supply)
